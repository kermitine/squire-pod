...
func TestWriteConfigToDiskWithErrorPersistsEmptyReminders(t *testing.T) {
	...
	APIConfig.Productivity.F1 = F1Config{Enable: true, PregameMinutes: 60, LiveUpdateMinutes: 10, NotifyFinal: true, NotifyQualifying: true, AllowedStart: "08:00", AllowedEnd: "22:00"}
	...
	if !persisted.Productivity.F1.Enable || persisted.Productivity.F1.LiveUpdateMinutes != 10 || !persisted.Productivity.F1.NotifyFinal || !persisted.Productivity.F1.NotifyQualifying || persisted.Productivity.F1.AllowedStart != "08:00" {
